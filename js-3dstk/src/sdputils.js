...
/* exported setCodecParam, iceCandidateType, formatTypePreference,
   ...
   function maybePreferCodec(sdp, type, dir, codec) {
     ...
     //remove a=extmap-allow-mixed to back-compatible which is introduce in webrtc version M71
     var extmapLineIndex = sdpLines.indexOf('a=extmap-allow-mixed');
     if(extmapLineIndex != -1)
     {
        sdpLines.splice(extmapLineIndex, 1);
     }
     //end of back-compatible of M71
